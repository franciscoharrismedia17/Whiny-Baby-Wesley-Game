...
function createLeadUI(){
  ...
  const firstNameField = createInputField('First Name', 'firstName', 'text');
  const lastNameField = createInputField('Last Name', 'lastName', 'text');
  ...
  leadForm.appendChild(firstNameField.wrapper);
  leadForm.appendChild(lastNameField.wrapper);
